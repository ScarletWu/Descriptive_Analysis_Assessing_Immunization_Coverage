---
title: "A Descriptive Analysis Assessing Immunization Coverage Rates in Toronto's Schools"
...
The histograms representing the distribution of vaccination coverage rates for MMR (Measles, Mumps, and Rubella) and DTP (Diphtheria, Tetanus, and Pertussis) among school pupils in Toronto.
```{r}
#| echo: false
#| eval: true
#| warning: false
...
#| fig-subcap: ["DTP histogram","MMR histogram"]
#| echo: false
#| warning: false
#| message: false
#| layout-ncol: 2

DTP_hist1718 <- hist(analysis_data$dtp_coverage_rate_percent,
     main = "Histogram of DTP Coverage Rate", 
     xlab = "DTP Coverage Rate (%)", breaks = 30)

MMR_hist1718 <- hist(analysis_data$mmr_coverage_rate_percent,
...
```{r}
#| label: MMR_histogram
#| fig-cap: histogram of MMR coverage rate percent
#| echo: false
#| warning: false
#| message: false
