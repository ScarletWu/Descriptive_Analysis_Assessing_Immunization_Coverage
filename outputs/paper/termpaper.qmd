...
The data is downloaded from opendatatoronto (@opendatatoronto). This paper is interested in variables, including DTP coverage rate and MMR coverage rate. Thus, the cleaned data only contain the varables of interest.
...
### Read dataset
analysis_data <- read_csv("/cloud/project/outputs/data/analysis_data.csv")
analysis_data
